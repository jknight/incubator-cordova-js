...
DebugConsole.DEBUG_LEVEL   = 1;
DebugConsole.LOG_LEVEL   = 1;
...
/**
 * Print a normal debug message to the console
 * @param {Object|String} message Message or object to print to the console
 */
DebugConsole.prototype.debug = function(message) {
    origConsole_log.apply(origConsole, arguments)
    
    if (this.logLevel <= DebugConsole.DEBUG_LEVEL) {
        exec(null, null, 'Debug Console', 'log', [ stringify(message), { logLevel: 'DEBUG' } ]);
    }
};
...
DebugConsole.prototype.log = function(message) {
    ...
    if (this.logLevel <= DebugConsole.LOG_LEVEL) {
        exec(null, null, 'Debug Console', 'log', [ stringify(message), { logLevel: 'LOG' } ]);
    }
};
 ...
 * @param {Object|String} message Message or object to print to the console
 */
DebugConsole.prototype.info = function(message) {
...
/**
 * Print a normal warn message to the console
 * @param {Object|String} message Message or object to print to the console
 */
